...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $universitesProgramme->universite_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $universitesProgramme->universite_id)]
            )
        ?></li>
...
<div class="universitesProgrammes form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Universites Programme') ?></legend>
        <?php
        ?>
    </fieldset>
